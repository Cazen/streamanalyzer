...
import { StreamAnalyzerSharedModule } from 'app/shared';
import { StreamAnalyzerCoreModule } from 'app/core';
import { StreamAnalyzerAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        StreamAnalyzerAppRoutingModule,
        ...
        StreamAnalyzerSharedModule.forRoot(),
...
export class StreamAnalyzerAppModule {
